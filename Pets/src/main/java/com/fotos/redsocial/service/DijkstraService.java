...
public class DijkstraService {
    ...
    public PathResponse findShortestPath(String startId, String endId) {
        ...
        // "distances": Almacena la distancia más corta conocida desde `startId` hasta cada nodo.
        Map<String, Double> distances = new HashMap<>();
        //"previous": Almacena el nodo predecesor en el camino más corto. Sirve para reconstruir la ruta.
        Map<String, String> previous = new HashMap<>();
        // "pq": Cola de prioridad que ordena los nodos por su distancia al nodo de inicio.
        PriorityQueue<Node> pq = new PriorityQueue<>();

        // Inicializar todas las distancias como infinito, ya que no conocemos ninguna ruta.
        ...
        while (!pq.isEmpty()) {
            ...
            // Optimización: si el nodo actual es el destino, podemos detenernos,
            // ya que Dijkstra garantiza que hemos encontrado el camino más corto hacia él.
            if (currentId.equals(endId)) break;

            // Ignorar nodos si ya hemos encontrado un camino más corto hacia ellos.
    ...
    private PathResponse reconstructPath(Map<String, String> previous, String endId, Map<String, Double> distances) {
        ...
        // Retroceder a través del mapa de predecesores hasta llegar al nodo de inicio (cuyo predecesor es null).
        while (currentId != null) {
            Location current = locationRepository.findById(currentId)
                .orElseThrow(() -> new RuntimeException("Location not found"));
            //Añadir la ubicación al principio de la lista para mantener el orden correcto (inicio -> fin).
